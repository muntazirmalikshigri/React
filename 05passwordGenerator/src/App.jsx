...
function App() {
 ...
 const passworgGenerator = useCallback(()=>{
  let pass = "";
 ...
 useEffect(()=>{
passworgGenerator()
 },[numAllowed , charAllowed , length , passworgGenerator])
  return (
    <>
     <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-800' > 
      <h1 className='text-4xl text-white text-center'>Password Generator</h1>
         <div className='flex shadow rounded-lg overflow-hidden mb-4'>
             <input type="text" value={password} placeholder='password' className='outline-none w-full text-center' readOnly ref={passwordRef}/>
